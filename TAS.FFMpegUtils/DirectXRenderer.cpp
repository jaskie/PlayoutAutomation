...
//      to do your own rendering. See CTriangleDirectXRenderer for an example.
...
//
//  Member:
//      DirectXRenderer ctor
//
//------------------------------------------------------------------------------
DirectXRenderer::DirectXRenderer() : m_pd3dDevice(NULL), m_pd3dDeviceEx(NULL), m_pd3dRTS(NULL)
{
}
...
//
//  Member:
//      DirectXRenderer::CheckDeviceState
//
//  Synopsis:
...
//------------------------------------------------------------------------------
HRESULT
DirectXRenderer::CreateSurface(UINT uWidth, UINT uHeight, bool fUseAlpha, UINT m_uNumSamples)
{
	HRESULT hr = S_OK;
...
//------------------------------------------------------------------------------
HRESULT
DirectXRenderer::Init(IDirect3D9 *pD3D, IDirect3D9Ex *pD3DEx, HWND hwnd, UINT uAdapter)
{
	HRESULT hr = S_OK;
