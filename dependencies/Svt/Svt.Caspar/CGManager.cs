...
namespace Svt.Caspar
{
    public class CGManager
    {
        ...
        {
            Channel.Connection.SendRequest("CG " + Channel.Id + " ADD " + layer + " \"" + template + "\" " + (bPlayOnLoad ? "1" : "0") + " \"" + (data ?? string.Empty) + "\"");
        }
        public void Add(int videoLayer, int layer, string template, bool bPlayOnLoad, string data)
        {
            if (videoLayer == -1)
                ...
                Channel.Connection.SendRequest("CG " + Channel.Id + "-" + videoLayer + " ADD " + layer + " \"" + template + "\" " + (bPlayOnLoad ? "1" : "0") + " \"" + (data ?? string.Empty) + "\"");
        }
        ...
        {
            Channel.Connection.SendRequest("CG " + Channel.Id + " ADD " + layer + " \"" + template + "\" " + (bPlayOnLoad ? "1" : "0") + " \"" + (data?.ToAMCPEscapedXml() ?? string.Empty) + "\"");
        }
        public void Add(int videoLayer, int layer, string template, bool bPlayOnLoad, ICGDataContainer data)
        {
            if (videoLayer == -1)
                ...
                Channel.Connection.SendRequest("CG " + Channel.Id + "-" + videoLayer + " ADD " + layer + " \"" + template + "\" " + (bPlayOnLoad ? "1" : "0") + " \"" + (data?.ToAMCPEscapedXml() ?? string.Empty) + "\"");
        }

        public void Remove(int layer)
        {
            Channel.Connection.SendRequest("CG " + Channel.Id + " REMOVE " + layer);
        }
        public void Remove(int videoLayer, int layer)
        {
            if (videoLayer == -1)
                ...
                Channel.Connection.SendRequest("CG " + Channel.Id + "-" + videoLayer + " REMOVE " + layer);
        }

        public void Clear()
        {
            Channel.Connection.SendRequest("CG " + Channel.Id + " CLEAR");
        }
        public void Clear(int videoLayer)
        {
            if (videoLayer == -1)
                ...
                Channel.Connection.SendRequest("CG " + Channel.Id + "-" + videoLayer + " CLEAR");
        }

        public void Play(int layer)
        {
            Channel.Connection.SendRequest("CG " + Channel.Id + " PLAY " + layer);
        }
        public void Play(int videoLayer, int layer)
        {
            if (videoLayer == -1)
                ...
                Channel.Connection.SendRequest("CG " + Channel.Id + "-" + videoLayer + " PLAY " + layer);
        }

        public void Stop(int layer)
        {
            Channel.Connection.SendRequest("CG " + Channel.Id + " STOP " + layer);
        }
        public void Stop(int videoLayer, int layer)
        {
            if (videoLayer == -1)
                ...
                Channel.Connection.SendRequest("CG " + Channel.Id + "-" + videoLayer + " STOP " + layer);
        }

        public void Next(int layer)
        {
            Channel.Connection.SendRequest("CG " + Channel.Id + " NEXT " + layer);
        }
        public void Next(int videoLayer, int layer)
        {
            if (videoLayer == -1)
                ...
                Channel.Connection.SendRequest("CG " + Channel.Id + "-" + videoLayer + " NEXT " + layer);
        }

        public void Update(int layer, string data)
        {
            Channel.Connection.SendRequest("CG " + Channel.Id + " UPDATE " + layer + " " + " \"" + data + "\"");
        }
        public void Update(int videoLayer, int layer, string data)
        {
            if (videoLayer == -1)
                ...
                Channel.Connection.SendRequest("CG " + Channel.Id + "-" + videoLayer + " UPDATE " + layer + " " + " \"" + data + "\"");
        }


        public void Invoke(int layer, string method)
        {
            Channel.Connection.SendRequest("CG " + Channel.Id + " INVOKE " + layer + " " + method);
        }
        public void Invoke(int videoLayer, int layer, string method)
        {
            if (videoLayer == -1)
                ...
                Channel.Connection.SendRequest("CG " + Channel.Id + "-" + videoLayer + " INVOKE " + layer + " " + method);
        }


        public void Info()
        {
            Channel.Connection.SendRequest("CG " + Channel.Id + " INFO");
        }
        public void Info(int videoLayer)
        {
            if (videoLayer == -1)
                ...
                Channel.Connection.SendRequest("CG " + Channel.Id + "-" + videoLayer + " INFO");
        }
    }
