...
namespace System.Net.FtpClient {
    ...
    public class FtpClient : IFtpClient {
        ...
        /// </summary>
        protected readonly Mutex m_lock = new Mutex();
        ...
        internal virtual FtpDataStream OpenPassiveDataStream(FtpDataConnectionType type, string command, long restart) {
        ...
        /// <param name="restart">Restart location in bytes for file transfer</param>
        /// <returns>A data stream ready to be used</returns>
        internal virtual FtpDataStream OpenActiveDataStream(FtpDataConnectionType type, string command, long restart) {
        ...
        internal virtual FtpDataStream OpenDataStream(string command, long restart) {
