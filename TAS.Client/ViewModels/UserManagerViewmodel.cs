...
namespace TAS.Client.ViewModels
{
    public class UserManagerViewmodel: ViewModelBase
    {
        ...
        public UserManagerViewmodel(IAuthenticationService authenticationService)
        {
            ...
            CommandAddUser = new UiCommand(CommandName(nameof(AddUser)), AddUser);
            CommandDeleteUser = new UiCommand(CommandName(nameof(DeleteUser)), DeleteUser, CanDeleteUser);
            CommandAddGroup = new UiCommand(CommandName(nameof(AddGroup)), AddGroup);
            CommandDeleteGroup = new UiCommand(CommandName(nameof(DeleteGroup)), DeleteGroup, CanDeleteGroup);
        ...
        private void DeleteUser(object _) => SelectedUser.Model.Delete();

        private bool CanDeleteUser(object _) => SelectedUser != null;

        private void AddGroup(object _)
        {
        ...
        private void DeleteGroup(object _) => SelectedGroup.Model.Delete();

        private bool CanDeleteGroup(object _) => SelectedGroup != null;
