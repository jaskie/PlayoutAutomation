...
using IPersistentMedia = TAS.Common.Database.Interfaces.Media.IPersistentMedia;
...
namespace TAS.Common.Database.Interfaces
{
    public interface IDatabase
    {
        ...
        bool ArchiveContainsMedia(IArchiveDirectoryProperties dir, IMediaProperties media);
        ...
        bool DeleteMedia(Media.IAnimatedMedia animatedMedia);
        bool DeleteMedia(Media.IArchiveMedia archiveMedia);
        bool DeleteMedia(Media.IServerMedia serverMedia);
        ...
        List<T> FindArchivedStaleMedia<T>(IArchiveDirectoryServerSide dir) where T : Media.IArchiveMedia, new();
        ...
        bool InsertMedia(Media.IAnimatedMedia animatedMedia, ulong serverId);
        bool InsertMedia(Media.IArchiveMedia archiveMedia, ulong serverid);
        bool InsertMedia(Media.IServerMedia serverMedia, ulong serverId);
        ...
        T ArchiveMediaFind<T>(IArchiveDirectoryServerSide dir, Guid mediaGuid) where T : Media.IArchiveMedia, new();
        MediaDeleteResult MediaInUse(IEngine engine, Common.Interfaces.Media.IServerMedia serverMedia);
        ...
        List<T> ArchiveMediaSearch<T>(IArchiveDirectoryServerSide dir, TMediaCategory? mediaCategory, string search) where T : Media.IArchiveMedia, new();
        ...
        void UpdateMedia(Media.IAnimatedMedia animatedMedia, ulong serverId);
        void UpdateMedia(Media.IArchiveMedia archiveMedia, ulong serverId);
        void UpdateMedia(Media.IServerMedia serverMedia, ulong serverId);
        ...
        void LoadAnimationDirectory<T>(IMediaDirectoryServerSide directory, ulong serverId) where T : Media.IAnimatedMedia, new();
        void LoadServerDirectory<T>(IMediaDirectoryServerSide directory, ulong serverId) where T : Media.IServerMedia, new();
        IArchiveDirectoryServerSide LoadArchiveDirectory<T>(IMediaManager manager, ulong idArchive) where T : IArchiveDirectoryServerSide, new();
