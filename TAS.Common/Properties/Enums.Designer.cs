...
namespace TAS.Common.Properties {
    ...
    public class Enums {
        ...
        /// <summary>
        ///   Looks up a localized string similar to First 4 channels (dual-stereo).
        /// </summary>
        public static string TAudioChannelMappingConversion_FirstFourChannels {
            get {
                return ResourceManager.GetString("TAudioChannelMappingConversion_FirstFourChannels", resourceCulture);
            }
        }
