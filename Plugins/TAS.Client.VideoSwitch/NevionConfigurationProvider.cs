...
namespace TAS.Server.VideoSwitch
{
    ...
    public class NevionConfigurationProvider : IPluginConfigurationProvider
    {
        ...
        public IPluginConfiguratorViewModel GetConfiguratorViewModel(IEngineProperties engine) => new NevionConfiguratorViewModel(engine);
