...
namespace TAS.Client.Config
{
    public class ConnectionStringViewmodel : OkCancelViewmodelBase<MySqlConnectionStringBuilder>
    {
        ...
        public string Server { get { return _server; } set { SetField(ref _server, value, "Server"); } }
        public uint Port { get { return _port; } set { SetField(ref _port, value, "Port"); } }
        public string Database { get { return _database; } set { SetField(ref _database, value, "Database"); } }
